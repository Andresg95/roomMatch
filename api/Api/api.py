...
def matchs_ia_hombres():
    ...
    tiempoPF= ((time.process_time_ns() - tiempoPI)/60000000000)
    ...
    for label, grp in cluster.items():
        ...
        cluster_data["label"] = str(label)
        output.append(cluster_data)
    tiempoCF= ((time.process_time_ns()-tiempoCI)/60000000000)
    tiempoTF= ((time.process_time_ns()-tiempoTI)/60000000000)
...
def test_ia():
    ...
    labels, error, nfound = PC.kmedoids(dist2, nclusters=5, npass=100)
    cluster = dict()
    output = []
